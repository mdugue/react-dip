    ...
    ;(b = (function() {
      ...
      (function() {
        ...
        !(function(a, b, c) {
          ...
          (d.Interpolation = function(a, b, d) {
            return function(e) {
              return d(
                (function c(a, b, d) {
            ...
            function b(b) {
              var d = {inset: !1, lengths: [], color: null},
                e = a.consumeRepeated(
                  function c(b) {
                    var c
                    return (c = a.consumeToken(/^inset/i, b))
                      ? ((d.inset = !0), c)
          ...
          (function(a, b) {
            function c(a) {
              ...
              var b = f.fillStyle
              if (
                ((f.fillStyle = '#fff'), (f.fillStyle = a), b == f.fillStyle)
              ) {
                f.fillRect(0, 0, 1, 1)
          ...
          (function(a, b) {
            ...
            function d(a, b) {
              ...
              if (/^[^(]*$|^calc/.test(b)) {
                var d = {}
                b = (b = b.replace(/calc\(/g, '(')).replace(a, function(a) {
                  return (d[a] = null), 'U' + a
                })
                for (
                  var e = 'U(' + a.source + ')',
      ...
      (function() {
        if (void 0 === document.createElement('div').animate([]).oncancel) {
          ...
          var c = window.Element.prototype.animate
      ...
      (function(a) {
        ...
        try {
          var f =
            '0' == getComputedStyle(b).getPropertyValue('opacity') ? '1' : '0'
